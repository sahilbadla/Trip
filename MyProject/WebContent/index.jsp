      ...
      var myDataRef = new Firebase('https://sahil-firebase.firebaseIO.com/');
		...
		<div id="bg">
			<div id="outer">
				<div id="header">
					...
					<div id="nav">
						<ul>
							...
							<li>
								<a href="NewFile2.jsp">Apps</a>
							</li>
							<li>
								<a href="chatApp.jsp">Chat Box</a>
							</li>
							<li>
								<a href="#">Downloads</a>
							</li>
				...
				<div id="banner">
					<img src="top.jpg" width="1124" height="212" alt="image" />
				</div>
				<div id="main">
					<div id="sidebar1">
						<h3>
					...
					<div id="sidebar2">
						...
						<ul class="linkedList">
							<li class="first">
								<a href="#">Euismod parturient dolor</a>
							</li>
							<li>
								<a href="#">Malesuada dignissim aenean</a>
							</li>
							<li>
								<a href="#">Felis amet condimentum</a>
							</li>
							<li>
								<a href="#">Duis rutrum urna congue</a>
							</li>
							<li>
								<a href="#">Iaculis etiam sed nibh</a>
							</li>
							<li class="last">
								<a href="#">Metus dolor et consequat</a>
							</li>
						</ul>
						<h3>
							Some Facts
						...
						<p>
							...
							Aliquam proin nisl mus ultrices morbi consequat veroeros dolore.
						</p>
					</div>
					<div id="content">
						<div id="box1">
						...
						<div id="box3">
							...
							<ul class="imageList">
								<li class="first">
									<img class="left" src="images/pic2.jpg" width="60" height="60" alt="" /> <span>Commodo proin lacinia blandit aenean orci penatibus.</span>
								</li>
								<li>
									<img class="left" src="images/pic2.jpg" width="60" height="60" alt="" /> <span>Nulla elit parturient eleifend aenean dictum proin.</span>
								</li>
								<li class="last">
									<img class="left" src="images/pic2.jpg" width="60" height="60" alt="" /> <span>Feugiat ut ut lectus cubilia faucibus condimentum.</span>
								</li>
							</ul>
						</div>
						<br class="clear" />
				...
				<div id="footer">
					<div id="footerContent">
						...
						<p>
							Project built with respect to Object Oriented Design Course CS251-B.
					...
					<div id="footerSidebar">
						...
						<ul class="linkedList">
							<li class="first">
								<a href="http://sahilbadla.blogspot.com/">Sahil Badla</a>
							</li>
							<li>
								<a href="#">SomeOne</a>
							</li>
			...
			<div id="copyright">
				&copy; SSB | Design by Badla Productions
			</div>
		</div>
    </body>
</html>
